  ...
  return (
    <div className="min-h-screen bg-rp-bg">
      ...
      <header className="bg-slate-900/80 backdrop-blur-xl border-b border-slate-700/50 sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href="/login" className="hidden sm:flex items-center gap-1 px-3 py-2 text-xs text-slate-400 hover:text-white hover:bg-slate-800 rounded-lg transition-colors">
        ...
        {mobileMenu && (
          <div className="lg:hidden border-t border-slate-700/50 px-4 py-3 space-y-1 slide-up">
            ...
            <Link href="/login" onClick={() => setMobileMenu(false)} className="block px-4 py-2.5 text-sm text-blue-400 hover:bg-slate-800 rounded-lg">🏪 Espace Vendeur</Link>
          </div>
        )}
      </header>
        ...
        <div className="relative max-w-6xl mx-auto px-4 py-12 sm:py-20 text-center">
          ...
          <div className="max-w-xl mx-auto">
            <div className="relative">
              ...
              <Link href="/search" className="absolute right-2 top-1/2 -translate-y-1/2 px-4 py-2 bg-rp-primary text-white rounded-xl text-sm font-semibold hover:bg-rp-primary-dark transition-colors">
                Rechercher
              </Link>
            </div>
          </div>
          ...
          <div className="flex justify-center gap-3 mt-6">
            ...
            <Link href="#" className="flex items-center gap-2 px-4 py-2.5 bg-slate-800 border border-slate-700 text-slate-300 rounded-xl text-sm font-medium hover:bg-slate-700 transition-colors">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 space-y-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <section>
            <div className="flex items-center justify-between mb-4">
              ...
              <Link href="/search" className="text-xs text-rp-primary font-medium flex items-center gap-1 hover:underline">
        ...
        {/* Rapid Services */}
        <section>
          <h2 className="text-lg font-bold text-white mb-4">Nos services</h2>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            {[
