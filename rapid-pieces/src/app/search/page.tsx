...
export default function SearchPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 pb-24 lg:pb-8">
      ...
      {showFilters && (
        <BottomActionBar>
          <button onClick={handleSearch} className="flex-1 py-3.5 bg-red-600 hover:bg-red-500 text-gray-900 dark:text-white font-bold rounded-xl transition-all flex items-center justify-center gap-1.5">
            Voir les résultats
