    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 pb-24 lg:pb-8">
      ...
      <header className="sticky top-0 z-40 bg-white backdrop-blur-xl border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4 h-14 flex items-center gap-3">
          ...
          <h1 className="text-sm font-bold text-gray-400 dark:text-slate-500 dark:text-slate-500 ml-auto">Mes commandes</h1>
        </div>
      </header>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-4 space-y-4">
        ...
        <div className="grid grid-cols-3 gap-2">
          <div className="bg-white backdrop-blur-sm rounded-xl p-3 border border-gray-200 text-center">
            <div className="text-lg font-bold text-gray-900 dark:text-white dark:text-white">1</div>
            <div className="text-[10px] text-gray-400 dark:text-slate-500 dark:text-slate-500">En cours</div>
          </div>
          <div className="bg-white backdrop-blur-sm rounded-xl p-3 border border-gray-200 text-center">
            <div className="text-lg font-bold text-green-400">1</div>
            <div className="text-[10px] text-gray-400 dark:text-slate-500 dark:text-slate-500">Livrée</div>
          </div>
          <div className="bg-white backdrop-blur-sm rounded-xl p-3 border border-yellow-500/20 text-center">
            ...
            <div className="text-[10px] text-gray-400 dark:text-slate-500 dark:text-slate-500">Points</div>
          </div>
        </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between mt-2">
                      <span className="text-lg font-black text-gray-900 dark:text-white">{order.price.toLocaleString()} <span className="text-xs font-normal text-gray-400 dark:text-slate-500 dark:text-slate-500">FCFA</span></span>
                ...
                <div className="border-t border-gray-200 p-4 space-y-3">
                  {order.driver && (
                    <div className="bg-gray-50 rounded-xl p-3">
                      <div className="text-xs text-gray-400 dark:text-slate-500 dark:text-slate-500 mb-1">Livreur</div>
        ...
        <div className="bg-white backdrop-blur-sm rounded-2xl p-4 border border-gray-200">
          ...
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-xs text-gray-400 dark:text-slate-500 dark:text-slate-500">Prochain palier : Silver à 4,500 pts</span>
          </div>
