    ...
    <div className="min-h-screen bg-rp-bg pb-24 lg:pb-8">
      ...
      <header className="bg-slate-900/80 backdrop-blur-xl border-b border-slate-700/50 sticky top-0 z-50">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-sm font-bold text-white">Rapid Business</h1>
            <p className="text-[10px] text-slate-400">Solutions B2B pour professionnels</p>
          </div>
        </div>
      </header>
      ...
      <div className="max-w-4xl mx-auto px-4 py-4 space-y-6">
        ...
        <div className="bg-gradient-to-br from-purple-900/30 to-slate-900 rounded-2xl p-6 border border-purple-500/20 text-center">
          ...
          <h2 className="text-xl font-bold text-white mb-2">Rapid Business</h2>
        ...
        <div className="space-y-4">
          <h3 className="text-sm font-semibold text-slate-400 uppercase tracking-wide">Choisir un plan</h3>
          {plans.map((plan) => {
            ...
            return (
              <div
                ...
                className={`bg-slate-800/50 border rounded-2xl p-5 transition-all ${
                  plan.highlight ? `${plan.color} ring-1 ring-rp-primary/20` : 'border-slate-700/50'
                } ${selectedPlan === plan.name ? 'ring-2 ring-rp-primary' : ''}`}
              >
                {plan.highlight && (
                  <span className="text-[10px] bg-rp-primary text-white px-2 py-0.5 rounded-full font-bold mb-3 inline-block">⭐ Recommandé</span>
                )}
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-white">Plan {plan.name}</h4>
                ...
                <button
                  ...
                  className={`w-full py-3 rounded-xl text-sm font-bold transition-all ${
                    plan.highlight
                      ? 'bg-rp-primary text-white hover:bg-rp-primary-dark'
        ...
        <div className="space-y-3">
          <h3 className="text-sm font-semibold text-slate-400 uppercase tracking-wide">Ils nous font confiance</h3>
        ...
        <div className="bg-slate-800/50 border border-slate-700/50 rounded-2xl p-6 text-center">
          <h3 className="text-lg font-bold text-white mb-2">Prêt à passer au niveau supérieur ?</h3>
          <p className="text-sm text-slate-400 mb-4">Contactez notre équipe commerciale</p>
